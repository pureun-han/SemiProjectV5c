        ...
        <div class="row margin1050">
            <table class="table">
                ...
                <tr style="background: #ccff99">
                    <td class="text-left">${g.userid}</td>
                    <td class="text-right">${g.regdate} / ${g.thumbup}</td></tr>
                <tr style="background: #ffffcc">
                    <td colspan="2" class="text-left"
                        style="border-bottom: 3px solid black;">
                        <img src="${imgURL}${g.fname1}" class="img-fluid"><br>
                        <c:if test="${not empty g.fname2}">
                            <img src="${imgURL}${g.fname2}"
                                 class="img-fluid"><br></c:if>
                        <c:if test="${not empty g.fname3}">
                        <img src="${imgURL}${g.fname3}"
                             class="img-fluid"><br></c:if>
                    </td></tr>
                ...
                <c:if test="${not empty g.fname3}">
                    <tr><td class="text-left">이미지3</td><td>${g.fname3} (1.3MB)</td></tr>
                </c:if>
            </table>
        </div><!-- 본문 -->
