    ...
    <div id="main">
        ...
        <div class="row margin1050">
            <table class="table">
                ...
                <tr><td class="text-left">첨부1</td><td><a href="/pds/pdown.do?f=${p.fname}&pno=${p.pno}"> ${p.fname}</a> (${p.fsize}, ${p.fdown}회 다운로드함)</td></tr>
                <tr><td class="text-left">첨부2</td><td>${p.fname} (1.3MB, 1회 다운로드함)</td></tr>
            </table>
        </div><!-- 본문 -->

        <div class="row margin1050">
            <div class="col-6">
                <button type="button" id="updpds"
                        class="btn btn-warning"
                        style="margin-left: -14px">
                    <i class="fa fa-pencil"> </i>
                    수정하기
                </button>
                <button type="button" id="delpds"
